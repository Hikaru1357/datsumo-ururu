...
<html lang="ja" dir="ltr">
  ...
  <body>
     ...
     <div class="header-inner">
       ...
       <div class="header-content">
         <div class="header-left">
           <a href="/"><img src="img\header-logo.png" alt="脱毛サロンうるるのロゴ"></a>
           <a href="/"><h1><img src="img\header-ururu.png" alt="脱毛サロンうるる"></h1></a>
         </div>
         <div class="nb64 header-right">
           <div class="header-right-icons">
             <a href="q&a"><img src="img\header-circle1.png" alt="よくあるご質問"></a>
             <a href="salon#access"><img src="img\header-circle2.png" alt="アクセスはこちら"></a>
           </div>
           <div class="call">
             <p>お電話でのご予約やお問い合わせ</p>
         ...
         <nav class="menu-icon" style="display:none">
           ...
           <ul class="">
             <li class="icon-list"><a  href="/">トップページ</a></li>
             <li class="icon-list"><a  href="salon">当サロンについて</a></li>
             <li class="icon-list"><a  href="flow">脱毛の流れ</a></li>
             <li class="icon-list"><a  href="menu">脱毛メニュー・料金</a></li>
             <li class="icon-list"><a  href="blogs">スタッフブログ</a></li>
             <li class="icon-list"><a  href="q&a">よくあるご質問</a></li>
             <li class="icon-list"><a  href="otoiawase">ご予約、お問い合わせ</a></li>
           </ul>
         </nav>
       </div>
       <nav class="nb64">
         <ul>
           ...
           <li><a href="salon">当サロンについて</a></li>
           <li><a href="flow">脱毛の流れ</a></li>
           <li><a href="menu">脱毛メニュー・料金</a></li>
           <li><a href="blogs">スタッフブログ</a></li>
           <li><a href="otoiawase">ご予約、お問い合わせ</a></li>
         </ul>
       </nav>
     </div>
   </header>
   ...
   <ul class="breadcrumb">
      ...
      <li itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">
        <a href="otoiawase.php" itemprop="url">
        ...
        =================================================================== -->
          ...
          <section class="contact2">
            ...
            <div class="detail">
              ...
              <div class="clearfix">
                <a href="salon#access" class="fr to-access"><img src="img\contact-access.png" alt="アクセスはこちら"></a>
              </div>
            </div>
            <div class="clearfix">
